...
parser = argparse.ArgumentParser(description='PyTorch Cora Graph Classification Model')
parser.add_argument('--data', type=str, default='data', help='location of the data directory')
